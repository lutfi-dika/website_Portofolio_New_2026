...
export const en: Dictionary = {
  ...
  dashboard: {
    ...
    ownerBusiness: "Owner of KRAFDEV Digital Technology Studio",
  ...
  about: {
    ...
    bioTitle: "About",
    bio:"I am Muhammad Lutfi Andika, a web developer specializing in frontend and web development. I am passionate about creating websites that are not only visually appealing but also user-friendly, responsive, and intuitive.\n\nI am the founder and owner of KRAFDEV Digital Technology Studio, a business specializing in building websites and digital solutions. Through KRAFDEV, I apply my technical skills and creativity to real-world projects while meeting my clients' digital needs. To me, every project is an opportunity to learn, experiment, and create something better.",
