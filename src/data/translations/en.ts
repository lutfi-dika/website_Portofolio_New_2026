...
export const en: Dictionary = {
  ...
  dashboard: {
    ...
    heroTagline: "Crafting digital experiences through clean code and intuitive design.",
  ...
  about: {
    title: "About Me",
    subtitle: "Get to know me and my journey more closely.",
    bioTitle: "Biography",
    bio:"I am Muhammad Lutfi Andika, a Web Developer who blends code, design, and creativity to build modern digital experiences. I specialize in Front-End Development, Web Development, and UI/UX, utilizing technologies such as JavaScript, React, Next.js, Tailwind CSS, PHP, and Laravel. I enjoy transforming ideas into functional, responsive websites with distinct character. Through LUTFI.DEV and Webkraf Digital Studio, I continuously learn, experiment, build projects, and grow to create digital solutions that are not only visually appealing but also deliver real value.",
    ...
    goalsText:
      "To become a professional Frontend Developer who builds quality digital products — fast, accessible, and delightful to use.",
    journey: {
  ...
  projects: {
    title: "Projects",
    subtitle: "A collection of projects I have built and am building.",
