export const id = {
  ...
  dashboard: {
    ...
    ownerBusiness: "Owner KRAFDEV Digital Technology Studio",
  ...
  about: {
    ...
    bioTitle: "Biografi",
    bio: "Saya Muhammad Lutfi Andika, seorang Web Developer yang fokus pada Frontend dan Web Development. Saya memiliki ketertarikan dalam menciptakan website yang tidak hanya menarik secara visual, tetapi juga nyaman, responsif, dan mudah digunakan.\n\nSaya adalah founder dan owner dari KRAFDEV Digital Technology Studio, sebuah bisnis yang bergerak di bidang pembuatan website dan solusi digital. Melalui KRAFDEV, saya menerapkan kemampuan teknis dan kreativitas dalam mengerjakan project nyata serta membantu kebutuhan digital klien. Bagi saya, setiap project adalah kesempatan untuk belajar, bereksperimen, dan menciptakan sesuatu yang lebih baik.",
  ...
  resume: {
    ...
    generatedFrom: "CV generated from lutfiandika.my.id",
  },
  achievements: {
    title: "Prestasi",
